...
export const BUILT_IN_OBJECT_TYPES: ObjectType[] = [
  ...
  },
  {
    ...
    name: "Events",
    icon: "🗓️",
    description: "Personal events with dates, times, and locations",
    builtIn: true,
    defaultViewType: "calendar",
    defaultDatePropertyName: "Date",
    defaultSorts: [{ propertyName: "Date", direction: "asc" }],
    properties: [
      ...
      { name: "All Day", type: "checkbox", defaultValue: false },
  ...
  },
  {
    ...
    defaultSorts: [{ propertyName: "Next Follow-up", direction: "asc" }],
    properties: [
      { name: "Name", type: "text" },
      { name: "Company", type: "text" },
      { name: "Email", type: "url" },
  ...
  },
  {
    ...
    name: "Habit Tracker",
    icon: "\u2705",
    description: "Track daily habits with streaks, frequency, and categories",
    builtIn: true,
  ...
  },
  {
    ...
    name: "Task",
    icon: "\u2611\ufe0f",
    description: "To-do list with status, priority, due dates, and assignees",
    builtIn: true,
    defaultViewType: "board",
    defaultGroupByPropertyName: "Status",
  ...
  },
  {
    ...
    name: "Food Log",
    icon: "\ud83c\udf4e",
    description: "Track meals and nutrition with calories and macros",
    builtIn: true,
  ...
  {
    id: "builtin-workout-log",
    name: "Workout Log",
    icon: "\ud83c\udfcb\ufe0f",
    description: "Track exercises, sets, reps, and workout sessions",
    builtIn: true,
    defaultSorts: [{ propertyName: "Date", direction: "desc" }],
    properties: [
  ...
  },
  {
    ...
    name: "Budget",
    icon: "\ud83d\udcb0",
    description: "Track income and expenses by category with amounts and dates",
    builtIn: true,
    defaultSorts: [{ propertyName: "Date", direction: "desc" }],
    properties: [
