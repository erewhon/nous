  ...
  return (
    <div className="flex flex-col items-center gap-1.5">
      ...
      {selectedTool === "connection" && (
        <div
          className="rounded-lg px-3 py-1 text-xs shadow-md border"
          style={{
            backgroundColor: "var(--color-bg-secondary)",
            borderColor: "var(--color-border)",
        ...
        >
          {connectionState === "source-selected"
            ? "Click target card (Esc to cancel)"
            : "Click a card to start connection"}
        </div>
      )}
    </div>
  );
